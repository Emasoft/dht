...
@task(name="lint_workflows", description="lint_workflows")
...
@task(name="check_act_setup", description="check_act_setup")
...
@task(name="setup_act_environment", description="setup_act_environment")
...
@task(name="run_workflow", description="run_workflow")
def run_workflow(
    project_path: Path,
    event: str = "push",
    job: str | None = None,
