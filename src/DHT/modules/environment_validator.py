...
class EnvironmentValidator:
    ...
    def _extract_tool_version(self, tool: str, output: str) -> Optional[str]:
    ...
    def _extract_pip_version(self, output: str) -> Optional[str]:
    ...
    def _extract_uv_version(self, output: str) -> Optional[str]:
    ...
    def _extract_git_version(self, output: str) -> Optional[str]:
    ...
    def _extract_node_version(self, output: str) -> Optional[str]:
    ...
    def _extract_npm_version(self, output: str) -> Optional[str]:
    ...
    def _extract_docker_version(self, output: str) -> Optional[str]:
    ...
    def _extract_generic_version(self, output: str) -> Optional[str]:
