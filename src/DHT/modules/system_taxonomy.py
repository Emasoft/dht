...
from DHT.modules.system_taxonomy_constants import (
    PLATFORM_EXCLUSIONS,
...
def is_tool_available_on_platform(tool_name: str, platform_name: str = None) -> bool:
    ...
    if platform_name in PLATFORM_TOOLS:
        for category, tools in PLATFORM_TOOLS[platform_name].items():
...
def find_tool_category(tool_name: str) -> Optional[str]:
    """
