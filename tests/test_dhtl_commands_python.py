...
""")
    ...
    def dhtl_commands(self):
        ...
        with patch('src.DHT.modules.dhtl_commands.UVManager') as mock_uv:
            ...
            mock_uv_instance.run_command.return_value = {"success": True, "stdout": "", "stderr": "Installed 5 packages"}
            mock_uv_instance.generate_lock_file.return_value = True
            mock_uv.return_value = mock_uv_instance
    ...
    def test_setup_handles_missing_project(self, dhtl_commands, temp_project_dir):
        ...
        result = dhtl_commands.setup(
            path=str(temp_project_dir / "nonexistent")
        )
