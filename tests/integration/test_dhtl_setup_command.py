...
"""
        ...
        result = commands.setup(path=str(project_path))
...
"""
        ...
        result = commands.setup(path=str(project_path), from_requirements=True)
...
"""
        ...
        result = commands.setup(path=str(project_path), index_url="https://pypi.org/simple")
