...
from helpers import run_bash_command, mock_bash_script, create_mock_file
...
def test_uv_is_available():
    ...
    # Clean up
    rm -rf "$test_dir"
    ''' % (dht_dir, project_root, dht_dir, dht_dir, project_root)
...
def test_uv_command_help():
    ...
    uv_command help
    ''' % (dht_dir, project_root, dht_dir, dht_dir)
