...
""")
    ...
    def test_verify_uv_version_success(self) -> Any:
        ...
        mock_run_command.return_value = {"stdout": "uv 0.4.27", "stderr": "", "returncode": 0, "success": True}
    ...
    def test_verify_uv_version_too_old(self) -> Any:
        ...
        mock_run_command = Mock()
        mock_run_command.return_value = {"stdout": "uv 0.3.0", "stderr": "", "returncode": 0, "success": True}
    ...
    def test_create_venv_default(self, uv_manager, tmp_path) -> Any:
        ...
        with patch.object(uv_manager, "run_command") as mock_run:
            mock_run.return_value = {"stdout": "Created venv", "stderr": "", "success": True}
    ...
    def test_add_dependency(self, uv_manager, project_with_pyproject) -> Any:
        ...
        with patch.object(uv_manager, "run_command") as mock_run:
            with patch.object(uv_manager, "generate_lock_file") as mock_lock:
                mock_run.return_value = {"stdout": "Added numpy", "stderr": "", "success": True}

                result = uv_manager.add_dependency(project_with_pyproject, "numpy>=1.20", dev=True)
    ...
    def test_remove_dependency(self, uv_manager, project_with_pyproject) -> Any:
        ...
        with patch.object(uv_manager, "run_command") as mock_run:
            with patch.object(uv_manager, "generate_lock_file") as mock_lock:
                mock_run.return_value = {"stdout": "Removed requests", "stderr": "", "success": True}
    ...
    def test_run_script_module(self, uv_manager, tmp_path) -> Any:
        ...
        with patch.object(uv_manager, "run_command") as mock_run:
            ...
            result = uv_manager.run_script(tmp_path, "mymodule.main", args=["--help"])
                ...
                with patch.object(uv_manager, "create_venv") as mock_venv:
                    with patch.object(uv_manager, "install_dependencies") as mock_deps:
                        with patch.object(uv_manager, "generate_lock_file") as mock_lock:
                            ...
                            mock_deps.return_value = {"success": True, "method": "uv pip install -e"}

                            result = uv_manager.setup_project(project_with_pyproject, install_deps=True, dev=True)
