...
class TestSubprocessUtils:
    ...
    def test_command_failure_with_nonzero_exit(self):
    ...
    def test_stderr_capture_modes(self):
    ...
    def test_subprocess_context_manager(self):
    ...
    def test_subprocess_context_cleanup_on_exception(self):
    ...
    def test_command_with_shell_execution(self):
    ...
    def test_process_group_handling(self):
    ...
    def test_sensitive_command_masking(self):
    ...
    def test_concurrent_subprocess_execution(self):
