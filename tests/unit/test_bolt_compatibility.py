...
class TestBoltCommandAliases:
    ...
    def test_install_alias_for_setup(self) -> Any:
    ...
    def test_add_command_exists(self) -> Any:
    ...
    def test_remove_command_exists(self) -> Any:
    ...
    def test_upgrade_command_exists(self) -> Any:
    ...
    def test_check_command_exists(self) -> Any:
    ...
    def test_doc_command_exists(self) -> Any:
    ...
    def test_bin_command_exists(self) -> Any:
...
class TestBoltWorkspaceCommands:
    ...
    def test_workspaces_command_exists(self) -> Any:
    ...
    def test_project_command_exists(self) -> Any:
...
class TestBoltDefaultBehavior:
    ...
    def test_no_args_defaults_to_install(self, mock_dispatch) -> Any:
    ...
    @patch("DHT.modules.command_dispatcher.CommandDispatcher.dispatch")
    def test_unknown_command_defaults_to_run(self, mock_dispatch) -> Any:
...
class TestBoltCommandImplementations:
    ...
    def test_add_command_calls_uv_add(self) -> Any:
    ...
    def test_remove_command_calls_uv_remove(self) -> Any:
    ...
    def test_upgrade_command_calls_uv_add_upgrade(self, mock_run) -> Any:
    ...
    @patch("subprocess.run")
    def test_check_command_calls_mypy(self, mock_run) -> Any:
    ...
    def test_bin_command_prints_venv_bin_path(self, capsys) -> Any:
...
class TestWorkspaceDetection:
    ...
    def test_detect_workspace_from_pyproject(self, tmp_path) -> Any:
...
""")
    ...
    def test_iterate_workspace_members(self, tmp_path) -> Any:
