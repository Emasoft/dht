...
class DHTLActionTestRunner:
    ...
    def print_summary(self, results: list[dict[str, Any]]) -> None:
        ...
        for result in results:
            ...
            print(
                f"┃ {result['profile'].upper():<8} ┃ {result['passed']:>6} ┃ "
...
def main() -> None:
    ...
    parser.add_argument(
        "--profile", choices=["local", "remote", "both", "categories"], default="both", help="Test profile to run"
    )
    parser.add_argument("--coverage", action="store_true", help="Show command coverage report")
